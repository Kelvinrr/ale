...
class FrameChain(nx.DiGraph):
    ...
    """
    @classmethod
    def from_spice(cls, sensor_frame, target_frame, center_ephemeris_time, ephemeris_times=[], nadir=False, exact_ck_times=False, use_web=False, mission=""):
        frame_chain = cls()
        ...
        frame_chain.compute_time_dependent_rotiations(sensor_time_dependent_frames, sensor_times, mission, use_web=use_web)
        frame_chain.compute_time_dependent_rotiations(target_time_dependent_frames, target_times, mission, use_web=use_web)
    ...
    def compute_time_dependent_rotiations(self, frames, times, mission="", use_web=False):
        """
