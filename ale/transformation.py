...
class FrameChain(nx.DiGraph):
    ...
    def from_spice(cls, sensor_frame, target_frame, center_ephemeris_time, 
        ...
        frame_chain.compute_time_dependent_rotiations(sensor_time_dependent_frames, sensor_times, mission)
        frame_chain.compute_time_dependent_rotiations(target_time_dependent_frames, target_times, mission)
    ...
    def compute_time_dependent_rotiations(self, frames, times, mission=""):
        """
